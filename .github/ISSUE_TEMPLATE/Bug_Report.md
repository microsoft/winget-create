...
If this is an application crash, please also provide a Feedback Hub submission link so we can find your diagnostic data on the backend. Use the category "Apps > Windows Package Manager Create" and choose "Share My Feedback" after submission to get the link.
