# Windows Package Manager Manifest Creator Contributor's Guide
...
Once the team have approved an issue/spec, development can proceed. If no developers are immediately available, the spec can be parked ready for a developer to get started. Parked specs' issues will be labeled "Help Wanted". To find a list of development opportunities waiting for developer involvement, visit the Issues and filter on [the Help-Wanted label](https://github.com/microsoft/winget-create/labels/help%20wanted).
...
> ⚠ Remember: **changes you make may have unintended consequences with the way the Windows Package Manager and the validation in the community repository have been implemented!** Because of this, we will treat community PR's with the same level of scrutiny and rigor as commits submitted to the official Windows source by team members and partners.
...
Thank you in advance for your contribution! Now, [what's next on the list](https://github.com/microsoft/winget-create/labels/help%20wanted)? 😜